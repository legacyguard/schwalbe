      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <nav className="flex flex-wrap gap-x-4 gap-y-2" aria-label="Legal and Support">
            <a className="hover:text-white underline-offset-2 hover:underline" href="/support.en">Support</a>
            ...
            <a className="hover:text-white underline-offset-2 hover:underline" href="/support.cs">Podpora</a>
            ...
            <span className="mx-2 hidden sm:inline opacity-50">|</span>
            <a className="hover:text-white underline-offset-2 hover:underline" href="/support.sk">Podpora</a>
