...
import { getLanguageLabel, normalizeLocale, type LocaleCode } from '../../../../../packages/shared/src/config/languages'
      ...
      <nav className="container mx-auto px-4 py-4" aria-label="Global">
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <a href="/support" className="text-slate-200 hover:text-white hover:bg-slate-800/50 px-2 py-1 rounded" aria-label="Support">Support</a>
