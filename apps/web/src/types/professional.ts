...
// Professional Reviewer core shape for directory and API typing
export interface ProfessionalReviewer {
  ...
  specializations: Array<{ id?: string; name: string; category?: string }>;
  rating?: number;
...
// Minimal Consultation type for API typing
