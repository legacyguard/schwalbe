...
import { FAMILY_PLANS, type FamilyPlan } from '@schwalbe/logic';
                    ...
                    <div className='text-center space-y-4'>
                      ...
                      <div className='grid gap-4 md:grid-cols-3 text-sm'>
                        <div className='text-center space-y-2'>
                          ...
                          <Typography variant='body' className='font-medium'>Stronger Together</Typography>
                        ...
                        <div className='text-center space-y-2'>
                          ...
                          <Typography variant='body' className='font-medium'>Emergency Ready</Typography>
                          <Typography variant='small' className='text-muted-foreground'>
                        ...
                        <div className='text-center space-y-2'>
                          ...
                          <Typography variant='body' className='font-medium'>Peace of Mind</Typography>
                          <Typography variant='small' className='text-muted-foreground'>
