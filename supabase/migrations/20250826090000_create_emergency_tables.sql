-- Create tables for Emergency Activation System
-- This migration adds the missing tables referenced by the emergency system
...
-- Insert default detection rules for new users (will be handled by application logic)
-- These are example rules that would be created when a user enables emergency shield
